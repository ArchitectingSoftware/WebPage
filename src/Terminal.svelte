      ...
      <div class="row lead text-align-left">
        <div class="col">
          <p class="terminal-font text-white">
            Try interacting with my website using a terminal interface. At any time you can type <span class="text-success fw-bold">help</span> to get a list of commands. Note all commands have -h and --help options to get help on those commands and their options. To start, type the <span class="text-success fw-bold">dragon</span> command for fun.  Note that you have to click in the terminal area to activate it.
          </p>
